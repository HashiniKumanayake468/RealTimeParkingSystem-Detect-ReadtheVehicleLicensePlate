...
def loadOutputimage():
    ...
    if isRegisteredUser:
        strResult ='This User is \n registered \n' + detectedVehicleNumber
    else:
        strResult ='This User is \n not registered \n' + detectedVehicleNumber
    # y0, dy = 50, 4
    # for i, line in enumerate(strResult.split('\n')):
    #     y = 50 + i * 100;
    #     cv2.putText(image, line, (50, y ),cv2.FONT_HERSHEY_COMPLEX,1, (0, 0, 255), 2, cv2.LINE_AA)
    image = cv2.putText(image,strResult,(50, 50), cv2.FONT_HERSHEY_COMPLEX,1, (0, 0, 255), 2, cv2.LINE_AA)
